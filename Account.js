...
server.get(
    ...
    function (req, res, next) {
        ...
        // Try to get pledg merchant code
        var pledgMerchantCode = null;
        var pledgCurrentSite = dwsystem.Site.getCurrent();
        if (pledgCurrentSite && pledgCurrentSite.getCustomPreferenceValue('Pledg_merchantCode')) {
            pledgMerchantCode = pledgCurrentSite.getCustomPreferenceValue('Pledg_merchantCode');
        }
        ...
        // Get the current basket in order to retrieve some useful information
        ...
        res.render('account/accountDashboard', {
            ...
            order: basketModel,
            pledgMerchantCode: pledgMerchantCode,
            breadcrumbs: [
                {
